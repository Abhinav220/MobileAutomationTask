...
import com.saucelab.factory.PlaywrightFactory;
import com.saucelab.pages.web.*;
...
/**
 * End-to-End Shopping Flow Test for SauceLabs Demo Web App using Playwright.
 * Test Flow:
 ...
 */
public class WebShoppingFlowTest {
    
    private WebLoginPage loginPage;
    private WebProductsPage productsPage;
    private WebProductDetailsPage detailsPage;
    private WebCartPage cartPage;
    ...
    public void setUp() {
        System.out.println("\n========================================");
        System.out.println("  SAUCELAB WEB AUTOMATION TEST");
        System.out.println("========================================\n");
        
        // Initialize browser
        Properties prop = new PlaywrightFactory().initProp();
        PlaywrightFactory factory = new PlaywrightFactory();
        factory.initBrowser(prop);
    ...
    public void testLogin() {
        ...
        loginPage = new WebLoginPage(PlaywrightFactory.getPage());
    ...
    public void testSelectProduct() {
        ...
        detailsPage = productsPage.clickFirstProduct();
        
        // Wait for page to load
        detailsPage.waitForLoadState();
        
        // ASSERTION: Verify Product Details page is displayed
        Assert.assertTrue(detailsPage.isProductDetailsPageDisplayed(), 
            "ASSERTION FAILED: Product Details page should be displayed");
